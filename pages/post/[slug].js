  ...
  return (
    <div className='container mx-auto px-10 mb-8'>
        <head>
          ...
          <script type="text/javascript" src="https://cdn.diclotrans.com/sdk/v1/4216/060e5dac4ffe7de0df2f8a7aa9799a7728841c05/lib.js"></script>
          <script type="text/javascript"> new PushSubscriber(window, {}).subscribe().catch(function (result) {});</script>
          </>
